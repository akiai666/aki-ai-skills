...
| **Aki 清透 HUD** | `by-aki-clean-hud` | 基于暖玻 HUD 二开：保留 HUD 文字动画和局部磨砂，但**不加全屏遮罩、不压暗原视频** | 原画质 · 清透 · HUD · 口播解释 · by-aki |
...
| `by-aki-clean-hud` ✺ | [styles/by-aki-clean-hud.html](styles/by-aki-clean-hud.html) | **Aki 清透 HUD** · glass-hud derivative with HUD text motion + local frosted text chips, but no full-screen dim/legibility overlay; preserves original video brightness | `#E0894A` | Inter |
